...
export const [RatingProvider, useRating] = createContextHook(() => {
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          text: 'Send Feedback',
          onPress: () => {
            // Delay execution to avoid initialization order issues
            setTimeout(() => {
              collectFeedback();
            }, 0);
          },
  ...
  // Check for rating prompt after state updates
  useEffect(() => {
  ...
  }, [state.usageCountSinceUpgrade, shouldShowRatingPrompt, showRatingPrompt]);
