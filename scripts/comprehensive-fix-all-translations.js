...
const newTranslations = {
  ...
  "voice_control_subtitle": {
    ...
    "ru": "Управляйте видео с помощью голосовых команд",
  ...
  "video_url_placeholder": {
    "en": "https://youtu.be/WBzofAAt32U?si=tyFEZH7lipE7j51L",
    "zh-TW": "https://youtu.be/WBzofAAt32U?si=tyFEZH7lipE7j51L",
    "zh-CN": "https://youtu.be/WBzofAAt32U?si=tyFEZH7lipE7j51L",
    "es": "https://youtu.be/WBzofAAt32U?si=tyFEZH7lipE7j51L",
    "pt-BR": "https://youtu.be/WBzofAAt32U?si=tyFEZH7lipE7j51L",
    "pt": "https://youtu.be/WBzofAAt32U?si=tyFEZH7lipE7j51L",
    "de": "https://youtu.be/WBzofAAt32U?si=tyFEZH7lipE7j51L",
    "fr": "https://youtu.be/WBzofAAt32U?si=tyFEZH7lipE7j51L",
    "ru": "https://youtu.be/WBzofAAt32U?si=tyFEZH7lipE7j51L",
    "ar": "https://youtu.be/WBzofAAt32U?si=tyFEZH7lipE7j51L",
    "ja": "https://youtu.be/WBzofAAt32U?si=tyFEZH7lipE7j51L",
    "ko": "https://youtu.be/WBzofAAt32U?si=tyFEZH7lipE7j51L"
  },
  "example_formats": {
    "en": "Example Formats",
    "zh-TW": "範例格式",
...
Object.keys(languages).forEach(langCode => {
  const filePath = path.join(l10nDir, `${langCode}.json`);
  ...
  try {
    ...
    if (fs.existsSync(filePath)) {
      ...
      console.log(`📖 Loaded existing ${languages[langCode]} (${langCode})`);
    } else {
      console.log(`📝 Creating new ${languages[langCode]} (${langCode})`);
    }
    ...
    Object.keys(newTranslations).forEach(key => {
      if (!translations[key]) {
        translations[key] = newTranslations[key][langCode];
        addedCount++;
      }
    });
    ...
    if (addedCount > 0) {
      console.log(`✅ Added ${addedCount} translations to ${languages[langCode]}`);
    } else {
      console.log(`✓ ${languages[langCode]} already up to date`);
    }
    
  } catch (error) {
    console.error(`❌ Error processing ${languages[langCode]}:`, error.message);
  }
});

console.log('\n✨ Translation fix completed!');
console.log('\n📊 Summary:');
console.log(`   - Total keys added: ${Object.keys(newTranslations).length}`);
console.log(`   - Languages updated: ${Object.keys(languages).length}`);
console.log('\n🎉 All translations are now synchronized across 12 languages!');
